          ...
          <div className="px-8 py-6">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-800 font-medium">Chef's Tip</p>
                  <p className="text-sm text-blue-700 mt-1">{randomFact}</p>
                </div>
              </div>
            </div>
                ...
                <ol className="space-y-4">
                  {recipe.instructions.map((instruction, index) => (
                    <li key={index} className="flex items-start">
                      <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full bg-blue-600 text-white font-semibold text-sm mr-4">
                        {index + 1}
                      </div>
